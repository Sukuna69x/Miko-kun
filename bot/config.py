...
class Config:
    def __init__(self):
        try:
            ...
            self.BOT_TOKEN = config("BOT_TOKEN", "6607973704:AAFTGRk4D6pnOWfnGFufbMd760rxkL6Agwk")
            self.CACHE_DL = config("CACHE_DL", default=False, cast=bool)
            self.CAP_DECO = config("CAP_DECO", default="◉")
            self.C_LINK = config("C_LINK", default="@Animes_Empire")
            ...
            self.OWNER = config("OWNER", "7328629001")
